...
(function newFact() {
  var facts = ['"I\'ve got a lot on my plate, but I\'ve got a big fork" - Zakki Blakk',
			   ...
			   '"Yeah." - James Hetfield',
			   '"Isn\'t saying \"attorney at law\" the same as saying \"footballer at game\"?" - Zakki Blakk',
			   '"You can\'t force creativity, but you can force yourself to be in situations where creativity may arise." - Anthony Vincent',
			  ];
